...
func (m *MockLocal) InstallApplet(arg0 []byte) error {
	m.ctrl.T.Helper()
...
func (m *MockLocal) InstallOS(arg0 []byte) error {
	m.ctrl.T.Helper()
...
func (m *MockRemote) GetApplet() ([]byte, error) {
	m.ctrl.T.Helper()
...
func (m *MockRemote) GetOS() ([]byte, error) {
	m.ctrl.T.Helper()
...
// VerifyAndUnpack mocks base method.
func (m *MockFirmwareVerifier) VerifyAndUnpack(arg0 []byte) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifyAndUnpack", arg0)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// VerifyAndUnpack indicates an expected call of VerifyAndUnpack.
func (mr *MockFirmwareVerifierMockRecorder) VerifyAndUnpack(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VerifyAndUnpack", reflect.TypeOf((*MockFirmwareVerifier)(nil).VerifyAndUnpack), arg0)
}
